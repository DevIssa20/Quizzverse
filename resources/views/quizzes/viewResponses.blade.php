  ...
  <x-card class="p-10 mt-5">
    @if($empty == 1)
      <div class="flex justify-center">
        <span class="text-center text-2xl">No Responses Yet</span>
      </div>
    @else
      <div class="flex justify-between">
        <a class = "" href= "/quizzes/{{$quizze->id}}/viewResponses/{{$responseNum - 1}}">
        <i class="fa-solid fa-arrow-left"></i>Prev
        </a>
        <span class="text-center text-2xl">Response of User : {{$userName}}</span>
        <a class = "" href= "/quizzes/{{$quizze->id}}/viewResponses/{{$responseNum + 1}}">
